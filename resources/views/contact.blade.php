    ...
    <div class="container-xl px-4 my-4">
        <div class="card">
            ...
            <div class="card-footer">
                ...
                <label class="form-check-label d-inline" for="privacy_policy"> En soumettant ce formulaire, j'accepte que les informations saisies soient utilisées selon les finalités décrites dans la politique de confidentialité. </label><br>
        ...
        <div class="d-flex justify-content-center mt-3">
            <button type="submit" class="btn btn-primary btn-lg" form="contactForm"><i class="fa-solid fa-envelope me-2"></i>Envoyer</button>
        </div>
    </div>
@endsection
