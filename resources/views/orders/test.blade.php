...
<div class="my-4 container">
    ...
    <h1 class="pricing headline text-center mb-4" style="font-family: Roboto, sans-serif;">
        Choisissez votre formule</h1>
    <h3 class="pricing-sub-headline text-center">Toutes vos données fragmentées, copiées et réparties sur différents serveurs et Datacenters selon le niveau de disponibilité choisi.
                ...
                <div class="col">
                    <div class="col">
                        ...
                        <div class="col align-self-center m-4">
                            <div class="row range-slider-container align-items-center">
                                ...
                                <input type="range" class="rs-range flex-grow-1" name="taille" id="taille" min="10"
                                    max="5000" step="10" value="10" form="formOrder">
                            </div>
                        </div>
                    </div>
                    <div class="col text-center"><span>Trafic illimité - Bande passante : 500 Mbit/s à
                            1Gbit/s<br>Au dessus de 5000Go, veuillez nous&nbsp;<a class="text-secondary"
                                href="https://www.dedikam.com/contact/" target="_blank">contacter</a>.<br><br></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col">
                    <div class="form-floating">
                        <input type="text" name="form_access_name" data-bs-toggle="tooltip" data-bss-tooltip=""
                            ...
                            value="{{ old('form_access_name') }}" aria-describedby="validationform_access_nameFeedback">
                        <label class="form-label" for="access_name">Nom de l'accès<sup>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td style="vertical-align:middle">
                                        <div class="d-flex flex-column align-items-start">
                                            <div id="price_Y" class="ms-5 d-flex flex-wrap"><span id="recap_amount_Y"
                                                    class="fs-1 text-primary fw-bolder">2
