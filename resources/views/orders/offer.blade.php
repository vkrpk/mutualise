...
<div class="container-sm overflow-hidden p-0">
    ...
    <div class="row mx-2 mx-sm-0 g-2 m-3">
        ...
        <div class="my-4 range-slider-container text-center position-relative">
            ...
            <input type="range" class="rs-range flex-grow-1" name="form_diskspace" id="taille" min="10" max="5000" step="10" value="{{ Cart::getContent()->first()->attributes->form_diskspace ?? 0 }}" form="formOrder">
