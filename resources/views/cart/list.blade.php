    ...
    <div class="container-sm overflow-hidden">
        <div class="row text-center my-4">
            <div class="col-md-12 px-sm-0 ">
                <div class="alert alert-tertiaryBis fs-3 fw-bolder mb-0" role="alert">
                    <span>{{__("Panier")}}</span>
                </div>
            </div>
        </div>
                ...
                <section class="row" >
                    <div class="col-md-12 px-sm-0 mb-4">
                        ...
                        <div class="card rounded-0">
                            <div class="alert alert-tertiary fw-bolder mb-1 rounded-0" role="alert"><span>{{__("Récapitulatif de l'offre")}}</span></div>
                            <div class="card-body">
                                <div class="row justify-content-evenly">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 ps-1 pe-0">
                                            <span class="fst-italic"><i class="fa-solid fa-circle-arrow-right bg-white text-tertiary me-2"></i>{{__("Formule choisie")}} :</span>
                                            <span>{{ __(ucfirst($cartItem->attributes->form_level)) }}</span>
                                        </div>
                                        @if ($cartItem->attributes->buttonsRadioForOffer)
                                            <div class="col-12 col-sm-6 ps-1 pe-0">
                                                <span class="fst-italic"><i class="fa-solid fa-circle-arrow-right bg-white text-tertiary me-2"></i>Option :</span>
                                    ...
                                    <div class="row px-1 mt-2">
                                        <div class="d-flex justify-content-end px-0">
                                            <a href="{{ route('offers', ["id" => $cartItem->id]) }}" class="me-2"><button type="button" class="btn btn-secondary">{{__("Modifier")}}</button></a>
                        ...
                        <div class="card rounded-0">
                            <div class="alert alert-tertiary fw-bolder mb-1 rounded-0" role="alert"><span>{{ $cartItem->attributes->isFreeTrial == true ? __("Offre d'essai") : __("Proposition 1 : paiement à l'année")}}</span></div>
                            <div class="card-body">
                                ...
                                <div class="row pt-1">
                                    <div class="col text-end align-self-center p-1">
                                        <button id="{{$cartItem->id}}" class="btn btn-secondary" name="btnFormula" value="{{ $cartItem->attributes->isFreeTrial ? "free" : "yearly" }}"><i class="fa-solid fa-cart-shopping me-1"></i>{{ $cartItem->attributes->isFreeTrial == true ? __("Choisir la formule d'essai") : __("Choisir la formule annuelle") }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        @if ($cartItem->attributes->form_diskspace >= 170)
                            <div class="card rounded-0">
                                <div class="alert alert-tertiary fw-bolder mb-1 rounded-0" role="alert"><span>{{__("Proposition 2 : abonnement mensuel")}}</span></div>
                                <div class="card-body">
                                    <div class="row border-bottom justify-content-evenly">
                                        <div class="text-end p-1">
                                    ...
                                    <div class="row pt-1">
                                        <div class="col text-end align-self-center p-1">
                                            <button id="{{$cartItem->id}}" class="btn btn-secondary" name="btnFormula" value="monthly"><i class="fa-solid fa-cart-shopping me-1"></i>{{__("Choisir la formule mensuelle")}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
