<header class="fixed-top" style="position: relative;">
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button navbar-fixed-top bg-dedikam text-dedikam">
        <div class="container"><a class="navbar-brand" href="https://dedispace.dedikam.com/"><img src="assets/img/logo.png"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><div id="nav-icon"><span></span><span></span><span></span></div></button>
            <div class="collapse navbar-collapse justify-content-end" id="navcol-1">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"></li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link text-dedikam" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="flag-icon flag-icon-fr"></span>&nbsp;Français</a>
                        <div class="dropdown-menu"><a class="dropdown-item" href="#"><span class="flag-icon flag-icon-gb"></span>&nbsp;English</a></div>
                    </li>
