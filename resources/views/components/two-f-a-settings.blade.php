<div class="row justify-content-md-center mb-4">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <p>{{__("La double authentification (2FA) renforce la sécurité d'accès en faisant appel à deux méthodes (qu'on appelle aussi facteurs) pour vérifier votre identité. La double authentification protège du phishing, de l'ingénierie sociale et des attaques par force brute contre les mots de passe, et sécurise votre connexion contre des attaquants exploitant des identifiants faibles ou volés.")}}</p>
                ...
                @elseif($data['user']->loginSecurity->google2fa_enable)
                    <p>{{__("Si vous voulez désactiver la double authentification, veuillez confirmer votre mot de passe et cliquer sur le bouton 'Désactiver la double authentification'")}}</p>
